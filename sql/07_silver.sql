...
SELECT *  FROM silver.crm_prd_info; -- not cm 
...
select cst_firstname from silver.crm_cust_info where cst_firstname like '';



SELECT *  FROM silver.crm_prd_info where prd_cost=0; -- not cm 

SELECT * FROM silver.crm_sales_details;

-- retrieve oldest customer
-- retrieve younget customer
...
-- where 
-- p.product_category_id=p1.product_category_id
...
-- from products p1
-- where p1.product_price>(
-- select avg(p.product_price)
-- from products p
-- where p1.product_category_id=p.product_category_id
-- );
...
-- select o1.order_id
-- from orders o1
-- where o.order_customer_id=o1.order_customer_id
-- );

-- select o1.order_customer_id
-- from orders o1
-- where count();

-- select o.order_customer_id,count(o.order_customer_id)
-- from orders o
-- group by o.order_customer_id
-- order by count(o.order_customer_id);
...
-- select count(distinct cst_id) from crm_cust_info;
-- select count(cst_id) from crm_cust_info;

-- select ci.cst_id,count(*) from crm_cust_info c 
-- join crm_cust_info ci on c.cst_id = ci.cst_id 
-- group by ci.cst_id
-- having count(ci.cst_id)>1